...
<h3>🧠 Sobre mí</h3>
<ul>
  <li>Trabajo en <b>seguridad en la nube</b> y arquitectura AWS con enfoque práctico.</li>
  <li>Creo contenido educativo en <b>YouTube</b> para aprender AWS desde cero hasta nivel real de trabajo.</li>
  <li>Me enfoco en explicar el <b>qué, cómo y por qué</b> de cada solución.</li>
</ul>
...
<ul>
  <li>📦 Ejemplos de la serie <b>AWS Learning Series</b></li>
  <li>🛡️ Proyectos con enfoque en seguridad</li>
  <li>⚙️ Automatización con Terraform y Python</li>
  <li>🧩 Demos listas para clonar y probar</li>
</ul>

<h3>🚀 Repos destacados</h3>
<ul>
  <li>
    <a href="https://github.com/chaconerw/aws-learning-series"><b>aws-learning-series</b></a>
    — proyectos paso a paso de AWS (S3, Lambda, API Gateway, serverless).
  </li>
</ul>
...
<p align="center">
  <i>Aprender cloud no es memorizar servicios, es entender cómo se conectan.</i>
</p>
